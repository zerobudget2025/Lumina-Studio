    ...
    <div className="glass rounded-[2rem] p-6 shadow-2xl space-y-6 border-slate-700/50 backdrop-blur-xl">
      <div className="space-y-4">
        <label className="flex items-center justify-between">
          ...
          <span className="text-[9px] text-blue-500 font-bold bg-blue-500/10 px-2 py-0.5 rounded-full ring-1 ring-blue-500/20">Pro Optimized</span>
        </label>
        <TemplateSelector 
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pt-6 border-t border-slate-800/80">
          ...
          <div className="relative group">
            ...
            {isEnhancing && (
              <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md rounded-2xl flex flex-col items-center justify-center animate-in fade-in duration-300">
                ...
                <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Refining Prompt...</span>
              </div>
            )}
          </div>
        </div>
        ...
        {selectedBaseImage && (
          <div className="animate-in zoom-in-95 duration-500">
            <label className="block text-[10px] font-bold text-slate-500 uppercase mb-2 px-1 tracking-widest">Visual Reference</label>
        ...
        <div className="space-y-3">
          <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">Aspect Ratio</label>
        ...
        <div className="space-y-2">
          ...
          <p className="text-center text-[9px] text-slate-600 font-bold tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity">
